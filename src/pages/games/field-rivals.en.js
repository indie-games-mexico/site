...
import { JustifiedP, MainPanel, H1, H2, H3, H4 } from '../../components/common/elements';
                ...
                <MainPanel>
                    <Panel>
                        ...
                        <Grid>
                            ...
                            <Row>
                                <Col lg={12}>
                                <iframe width="100%" height="315" src="https://www.youtube.com/embed/EDKgR_Ncdhs" frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen={true}></iframe>
                                </Col>
                            </Row>
                            <Row>
                                <Col lg={12}>
                            ...
                            <Row>
                                <Col lg={12}>
                                    ...
                                    <JustifiedP>
                                        ...
                                        Each Team has its captain, logo, stage and music.
                                    </JustifiedP>
                                    TODO:
                                    include 3 pictures and create the stage and music section
                                </Col>
                            </Row>
                        </Grid>
                    </Panel>
